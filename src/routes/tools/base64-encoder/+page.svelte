...
<ToolLayout title="Base64 Encoder/Decoder" description="Encode and decode Base64 strings quickly and easily." category="Developer">
  <div class="space-y-4">
    <!-- Mode Toggle -->
    <div class="flex gap-2">
      <button 
        onclick={() => { mode = 'encode'; processBase64(); }}
        class="btn-primary"
      ...
      <button 
        onclick={() => { mode = 'decode'; processBase64(); }}
        class="btn-primary"
